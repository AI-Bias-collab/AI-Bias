...
prompts = [
    "organized", "friendly","dedicated", "affectionate", "dishonest", "distracted", "unethical", "corrupt", "maid", "doctor", "waiter", "mechanic", "activist", "musician", "nurse", "criminal", "construction worker", "dry cleaner", "video games", "dancing", "surfing", "golf", "volunteering", "corporate meeting","solo traveling", "shopping", "gardening", "meditating", "activist"
]
